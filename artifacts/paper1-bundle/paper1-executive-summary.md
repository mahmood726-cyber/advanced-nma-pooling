...
## Bias-Adjusted Model
- Estimated `nrs` bias term: 0.5635

## Bayesian Bias-Adjusted Model
- Backend used: `analytic`
- Posterior draws: 2000

## Prior Sensitivity
- Scenario count: 24
- `A` span: 0.0000 (min=0.0000, max=0.0000)
- `B` span: 0.1525 (min=0.9740, max=1.1265)
- `C` span: 0.1517 (min=1.9712, max=2.1229)
