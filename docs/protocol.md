        # Advanced Nma Pooling: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/advanced-nma-pooling.git

        ## Objective

        Advanced NMA Pooling provides extended network meta-analysis pooling methods including component models, dose-response relationships, and inconsistency testing.
        ...
        - Code: https://github.com/mahmood726-cyber/advanced-nma-pooling.git
        - Dashboard: https://mahmood726-cyber.github.io/advanced-nma-pooling/
