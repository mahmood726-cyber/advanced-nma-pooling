...
- It states current limitations directly, including the present restriction of this draft to publication-suite and paper-bundle evidence, the continuous-only ML-NMR implementation, and the fact that DOI-backed archival through Zenodo remains pending even though the exact manuscript-result artifacts and aligned figure package are now included in a public GitHub submission snapshot.
...
https://github.com/mahmood726-cyber/advanced-nma-pooling/tree/f1000-submission-2026-03-14-final
